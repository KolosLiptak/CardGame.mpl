...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Iterable<SNode> sourceNodesQuery_1_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.players$gE2V);
  }
  public static Iterable<SNode> sourceNodesQuery_1_1(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.phases$kzON);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_6_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.values$zqg4);
  }
  ...
  private final Map<String, SourceNodeQuery> snqMethods = new HashMap<String, SourceNodeQuery>();
  {
    ...
    snqMethods.put("479138582688105216", new SNQ(i++));
    snqMethods.put("479138582686474297", new SNQ(i++));
    snqMethods.put("479138582686473809", new SNQ(i++));
  }
  @NotNull
  @Override
  ...
  {
    int i = 0;
    snsqMethods.put("6825941375526211353", new SNsQ(i++));
    snsqMethods.put("6825941375526514941", new SNsQ(i++));
    snsqMethods.put("4118050918680669578", new SNsQ(i++));
    snsqMethods.put("4118050918680670086", new SNsQ(i++));
    snsqMethods.put("479138582688053892", new SNsQ(i++));
    snsqMethods.put("479138582689285641", new SNsQ(i++));
  }
  @NotNull
  @Override
  ...
  private final Map<String, PropertyValueQuery> pvqMethods = new HashMap<String, PropertyValueQuery>();
  {
    ...
    pvqMethods.put("479138582688103737", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), "name"));
    ...
    pvqMethods.put("479138582685584053", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), "string"));
    pvqMethods.put("479138582685585028", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc59b314L, 0xf8cc59b315L, "value"), "0"));
    pvqMethods.put("6825941375526205892", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "playerRuntime"));
    pvqMethods.put("6825941375526509950", new PVQ(i++, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"), "phase"));
  }
  @NotNull
  @Override
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink players$gE2V = MetaAdapterFactory.getContainmentLink(0xe94dfae4e9d04770L, 0x965c58db5e543504L, 0x39b65bcfb2f86776L, 0x39b65bcfb2f8677dL, "players");
    /*package*/ static final SContainmentLink phases$kzON = MetaAdapterFactory.getContainmentLink(0xe94dfae4e9d04770L, 0x965c58db5e543504L, 0x39b65bcfb2f86776L, 0x26431eee60b1bc59L, "phases");
    ...
    /*package*/ static final SContainmentLink values$zqg4 = MetaAdapterFactory.getContainmentLink(0xe94dfae4e9d04770L, 0x965c58db5e543504L, 0x568258613b824594L, 0x568258613b82e587L, "values");
